...
import org.yh.ssoclient.utils.ClientIpUtil;
import org.yh.ssoclient.utils.JsonUtil;
...
public class WebRequestLogAspect {
    ...
    @Pointcut("execution(public * org.yh.ssoclient.controller.*.*(..))")
    public void wsLog() {
    }
